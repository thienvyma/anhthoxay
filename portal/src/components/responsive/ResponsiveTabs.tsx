/**
 * ResponsiveTabs Component for Portal
 * Tab navigation that adapts to screen size
 *
 * Requirements: 5.1, 5.2, 5.3, 5.4 - Horizontal scrolling tabs on mobile
 */
 ...
 * <ResponsiveTabs
 *   tabs={[
 *     { id: 'overview', label: 'Tổng quan', icon: 'ri-dashboard-line', content: <Overview /> },
 *     { id: 'bids', label: 'Đề xuất', icon: 'ri-file-list-line', content: <Bids /> },
 *   ]}
 *   activeTab={activeTab}
...
export function ResponsiveTabs({
  ...
  // Check scroll position for fade indicators - Property 5.2
  const checkScroll = () => {
  ...
  // Scroll active tab into view - Property 5.3
  useEffect(() => {
  ...
  // Render scroll mode (default) - Property 7
  return (
    <div className={className} data-testid={testId} data-breakpoint={deviceType}>
      {/* Tab bar with scroll */}
      <div style={{ position: 'relative' }}>
        {/* Left fade indicator - Property 5.2 */}
        {showLeftFade && (
          <div
            style={{
              position: 'absolute',
        ...
        {/* Right fade indicator - Property 5.2 */}
        {showRightFade && (
          <div
            style={{
              position: 'absolute',
      ...
      {/* Tab content - Property 5.4 */}
      <div style={{ paddingTop: isMobile ? tokens.space.md : tokens.space.lg }}>
