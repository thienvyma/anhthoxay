/**
 * ResponsiveModal Component for Portal
 * Modal that becomes full-screen on mobile
 *
 * Requirements: 3.1, 3.3 - Full-screen on mobile, stack buttons vertically
 */
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            {/* Footer - Property 4: Stack buttons vertically on mobile */}
            {footer && (
              <div
                style={{
                  display: 'flex',
