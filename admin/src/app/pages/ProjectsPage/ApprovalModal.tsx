 ...
 *
 * Confirmation modal for approving/rejecting projects.
 *
              ...
              <div style={{ padding: 24 }}>
                ...
                >
                  ...
                  <div style={{ color: tokens.color.muted, fontSize: 13, marginTop: 4 }}>
                    Chủ nhà: {project.owner.name}
                  </div>
                </div>

                <p style={{ color: tokens.color.muted, fontSize: 14, margin: '0 0 16px' }}>
                  {action === 'approve'
                    ? 'Bạn có chắc muốn duyệt công trình này? Công trình sẽ được đăng lên marketplace để nhà thầu có thể đấu giá.'
                    : 'Bạn có chắc muốn từ chối công trình này? Vui lòng nhập lý do từ chối.'}
                </p>
