      ...
      <Card>
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: 48, color: tokens.color.muted }}>
            ...
            {searchQuery || filterStatus ? 'Không tìm thấy kết quả' : 'Chưa có khách hàng nào'}
          </div>
        ) : (
        ...
        {totalPages > 1 && (
          <div style={{ 
            ...
            <span style={{ color: tokens.color.muted, fontSize: 13, marginLeft: 8 }}>
      ...
      <AnimatePresence>
        {selectedLead && (
          ...
          >
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
                <h2 style={{ color: tokens.color.text, margin: 0 }}>Chi tiết khách hàng</h2>
                <button
                  onClick={() => setSelectedLead(null)}
                  style={{
                    background: 'none',
